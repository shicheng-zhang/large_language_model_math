# PROJECT BUNDLE: v3
Root Directory: /home/magi-01/Desktop/work/programming/llm_maths/v3
Generated: Mon Jun 22 04:10:23 PM MDT 2026
...
symbol* symbol_simplify (symbol* source_symbol) {
    ...
    output_symbol -> value = source_symbol -> value;
    if (source_symbol->argument_count > 0 && first_argument) {
        output_symbol->arguments[0] = first_argument;
    }
    if (source_symbol->argument_count > 1 && second_argument) {
        output_symbol->arguments[1] = second_argument;
    }
    for (size_t i = 2; i < source_symbol->argument_count; i++) {
