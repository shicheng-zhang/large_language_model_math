...
value* compiler_compile(compiler* compiler_instance, symbol* symbol_node) {
    ...
    if (symbol_node->type == symbol_type_operation) {
        ...
        else if (strcmp(symbol_node->operation, "-") == 0) output_value = value_subtraction(arguments[0], arguments[1]);
        ...
        else if (strcmp(symbol_node->operation, "tanh") == 0) output_value = value_tanh(arguments[0]);
        else {
